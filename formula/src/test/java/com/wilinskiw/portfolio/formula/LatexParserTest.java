...
public class LatexParserTest {
    ...
    public void parseLatexCdotTest() {
        ...
        assertEquals("4*4+a*2", testFormula.getParsedForm());
    }
    ...
    public void parseLatexFracTest() {
        ...
        assertEquals("#mathUtils.div(42+6,a)+#mathUtils.div(2,4)", testFormula.getParsedForm());
    }

    @Test
    public void parseLatexSqrtTest() {
        Formula testFormula = latexParser.parse("\\sqrt{4}");
        assertEquals("T(java.lang.Math).sqrt(4)", testFormula.getParsedForm());
    }

    @Test
    public void parseLatexNsqrtTest() {
        Formula testFormula = latexParser.parse("\\sqrt[3]{27}");
        assertEquals("#mathUtils.nSqrt(27,3)", testFormula.getParsedForm());
    }

    @Test
    public void parseLatexPowTest() {
        Formula testFormula = latexParser.parse("4^{24}");
        assertEquals("T(java.lang.Math).pow(4,24)", testFormula.getParsedForm());
    }

    @Test
    public void parseLatexLog10Test() {
        Formula testFormula = latexParser.parse("\\log100");
        assertEquals("T(java.lang.Math).log10(100)", testFormula.getParsedForm());
    }

    @Test
    public void parseLatexDigitBaseLogTest(){
        Formula testFormula = latexParser.parse("\\log_24");
        assertEquals("#mathUtils.logBase(2,4)", testFormula.getParsedForm());
    }
    ...
    public void parseLatexNumberBaseLogTest(){
        ...
        assertEquals("#mathUtils.logBase(16,256)", testFormula.getParsedForm());
    }
    ...
    public void parseLatexSinTest(){
        ...
        assertEquals("#mathUtils.sin(90)", testFormula.getParsedForm());
    }

    @Test
    public void parseLatexCosTest(){
        Formula testFormula = latexParser.parse("\\cos90");
        assertEquals("#mathUtils.cos(90)", testFormula.getParsedForm());
    }

    @Test
    public void parseLatexTanTest(){
        Formula testFormula = latexParser.parse("\\tan90");
        assertEquals("#mathUtils.tan(90)", testFormula.getParsedForm());
    }

    @Test
    public void parseLatexPITest(){
        Formula testFormula = latexParser.parse("\\pi");
        assertEquals("T(java.lang.Math).PI", testFormula.getParsedForm());
    }
